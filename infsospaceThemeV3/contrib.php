...
<h1 class="searchResultsTitle">About <?php echo $theauth->first_name; ?>&nbsp;<?php echo $curauth->last_name; ?></h1>
...
<?php echo get_avatar( get_the_author_email(), '150' ); ?>
                                    	...
                                    	<dl>
                                        	<dt><?php echo $curauth->first_name; ?>&nbsp;<?php echo $curauth->last_name; ?></dt>
                                ...
                                <h1 class="searchResultsTitle">Posts by <?php echo $curauth->nickname; ?></h1>                              
