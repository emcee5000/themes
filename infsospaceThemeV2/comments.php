...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
                                ...
                                <div id="comments-list" class="comments">
                                        <h3 class="commentTitles"><?php printf($comment_count > 1 ? __('<span>%d</span> Comments', 'your-theme') : __('<span>One</span> Comment', 'your-theme'), $comment_count) ?></h3>
...
<?php if ( ! empty($comments_by_type['pings']) ) : ?>
                                ...
                                <div id="trackbacks-list" class="comments">
                                        <h3 class="commentTitles"><?php printf($ping_count > 1 ? __('<span>%d</span> Trackbacks', 'your-theme') : __('<span>One</span> Trackback', 'your-theme'), $ping_count) ?></h3>
...
<?php if ( 'open' == $post->comment_status ) : ?>
                                <div id="respond">
                                <h3 class="commentTitles"><?php comment_form_title( __('Post a Comment', 'your-theme'), __('Post a Reply to %s', 'your-theme') ); ?></h3>
