...
define( 'NOTIFIER_THEME_FOLDER_NAME', 'beauty-premium' ); // The theme folder name
define( 'NOTIFIER_CACHE_INTERVAL', 21600 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
define( 'NOTIFIER_XML_FILE', 'http://www.niubbys.altervista.org/beauty-premium.xml' );
...
function update_notifier() { 
    ...
    <div class="wrap">
		...
		<div id="instructions">
		    ...
		    <p>To get the latest update of the Theme, download the package <a href="http://www.freeminimalwptheme.com/downloadsproduct/download.php?file=2xOa%2FCsHV%2FORhKnt">here</a>.</p>
