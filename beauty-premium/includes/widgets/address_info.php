...
class address_info extends WP_Widget
{
    function address_info() 
    {
		$widget_ops = array( 
            ...
            'description' => __( 'Widget with a simple address information.', TEXTDOMAIN )
        );

		$control_ops = array( 'id_base' => 'address-info' );

		$this->WP_Widget( 'address-info', __( 'Address Info', TEXTDOMAIN ), $widget_ops, $control_ops );   
	}
	...
	function form( $instance )
	{
		...
		<p>
			<label><?php _e( 'Zip Code', TEXTDOMAIN ) ?>:
