	...
	<div id="wildHeaderLinks">
    	<div class="headerBlock">
    		<div id="checkUsOut">
    			...
    			<a href="http://www.facebook.com/pages/The-Wild-Animal-Experience-and-Park/297199157450" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/topBannerFacebook.png" alt="Facebook" /></a>
    		<?php/*	<a href="#" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/topBannerTwitter.png" alt="Twitter" /></a> */ ?>
    		</div>
    	</div>
        <div class="headerBlock">
...
<div id="wrapper" class="hfeed">
        <div id="header">
                <div id="masthead">
                    <div id="branding">
                        <div id="logo">
                        <a href="<?php echo get_settings('home'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/headerGraphic.jpg" alt="The Wild Animal Park" /></a>
                        </div>
