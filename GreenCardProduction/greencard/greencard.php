...
class KPS_GreenCard {
	...
	function __construct() {
	    ...
	    register_taxonomy( "courses", array("kpsgcdeal"), 
	   						array("hierarchical" => true, 'labels' => $labels, "singular_label" => "Course", "rewrite" => true));
...
function kp_gcdeals_shortcode( $atts, $content=null ) {
	...
	$result = "";
	$result .= "<div style='float: left; width: 550px; font-family:bebas; font-size:2em; color:#8cc63f; padding-bottom:20px;'>" . "What's the deal?" . "</div>";
	$result .= "<div style='float: left; width: 150px; font-family:bebas; font-size:2em; color:#8cc63f; padding-bottom:20px;'>" . "Date Posted" . "</div>";	
	$result .= "<div style='float: left; width: 150px; font-family:bebas; font-size:2em; color:#ec1a29; padding-bottom:20px;'>" . "Expires" . "</div>";		
	...
	foreach( $deals as $deal ) {
		...
		//$course = $course[ 0 ];
		$result .= "<div style='float: left; width: 550px;'>" . 
			"<div style='float: left; width: 210px'>" .
			"<img src='" . $image_url[0] . "' align='top'>" . 
			"</div>" . 
			"<div style='float: left; width: 340px;'><span style='font-family:bebas; font-size:2em; color:#666699;'>" .
			$course->name . "</span><span style='font-family:bebas; font-size:2em; color:#8cc63f;'>" . $custom["gc_deal_holes"][0] . " holes " . $deal_cart . 
