...
function kp_gcdeals_shortcode( $atts, $content=null ) {
	...
	$result = "";
	$result .= "<div style='float: left; width: 550px; font-family:bebas; font-size:2em; color:#8cc63f; padding-bottom:10px;'>" . "What's the deal?" . "</div>";
	$result .= "<div style='float: left; width: 150px; font-family:bebas; font-size:2em; color:#8cc63f; padding-bottom:10px;'>" . "Date Posted" . "</div>";	
	$result .= "<div style='float: left; width: 150px; font-family:bebas; font-size:2em; color:#ec1a29; padding-bottom:10px;'>" . "Expires" . "</div>";		
	...
	foreach( $deals as $deal ) {
		...
		$result .= "<div style='float: left; width: 550px;'>" . 
			...
			"</div>" . 
			"<div style='float: left; width: 340px; font-family:bebas; font-size:1.2em; color:#666699;'>" .
			$course->name . " " . $custom["gc_deal_holes"][0] . " holes " . $deal_cart . 
		...
		$result .= 	"<div style='float: left; width: 150px;'>" .
