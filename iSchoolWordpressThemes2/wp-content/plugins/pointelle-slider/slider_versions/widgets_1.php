<?php 
class Pointelle_Slider_Simple_Widget extends WP_Widget {
	function Pointelle_Slider_Simple_Widget() {
		$widget_options = array('classname' => 'sslider_wclass', 'description' => 'Insert Pointelle Slider' );
		$this->WP_Widget('pointelle_sslider_wid', 'Pointelle Slider - Simple', $widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo $before_widget;
		if($pointelle_slider['multiple_sliders'] == '1') {
		...
		echo $before_title . $after_title; 
		 get_pointelle_slider($slider_id,$set);
		echo $after_widget;
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("Pointelle_Slider_Simple_Widget");') );

//Category Widget
class Pointelle_Slider_Category_Widget extends WP_Widget {
	function Pointelle_Slider_Category_Widget() {
		$widget_options = array('classname' => 'ssliderc_wclass', 'description' => 'Pointelle Category Slider' );
		$this->WP_Widget('pointelle_ssliderc_wid', 'Pointelle Slider - Category', $widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo $before_title . $after_title; 
		 get_pointelle_slider_category($cat,$set);
		echo $after_widget;
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("Pointelle_Slider_Category_Widget");') );

//Recent Posts Widget
class Pointelle_Slider_Recent_Widget extends WP_Widget {
	function Pointelle_Slider_Recent_Widget() {
		$widget_options = array('classname' => 'ssliderr_wclass', 'description' => 'Pointelle Recent Posts Slider' );
		$this->WP_Widget('pointelle_ssliderr_wid', 'Pointelle Slider - Recent Posts', $widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo $before_title . $after_title; 
		 get_pointelle_slider_recent($set);
		echo $after_widget;
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("Pointelle_Slider_Recent_Widget");') );
?>