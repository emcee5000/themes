  ...
  <div id="content">
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <div class="entry-meta">
        <div class="authorAvitar"> <?php echo get_avatar( get_the_author_email(), '30' ); ?> </div>
        <div class="authorStuff"> <span class="meta-prep meta-prep-author">
          <?php _e('Posted by: ', 'your-theme'); ?>
          </span> <span class="author vcard"><a class="url fn n" href="<?php echo get_author_link( false, $authordata->ID, $authordata->user_nicename ); ?>" title="<?php printf( __( 'View all posts by %s', 'your-theme' ), $authordata->display_name ); ?>">
          <?php the_author(); ?>
          </a></span>
<br />
<span class="entry-date"><?php the_time( get_option( 'date_format' ) ); ?></span>            
        ...
        <div id="digDig"> <span style="padding:5px;">
          <?php if(function_exists('dd_twitter_generate')){dd_twitter_generate('Normal','iSchoolSU');} ?>
          </span> <span style="padding:5px;">
          <?php if(function_exists('dd_fblike_generate')){dd_fblike_generate('Like Box Count');} ?>
          </span> <span style="padding:5px;">
          <?php if(function_exists('dd_google1_generate')){dd_google1_generate('tall');} ?>
          </span> </div>
...
?>
        ...
        <div class="entry-content">
          ...
          <?php wp_link_pages('before=<div class="page-link">' . __( 'Pages:', 'your-theme' ) . '&after=</div>') ?>
             ...
             <div style="border-top: dotted #CCC; padding:10px 0 10px 0;"></div>
        </div>
        <!-- .entry-content -->
        
     
        <div class="entry-utility"> <span class="cat-links"><span class="entry-utility-prep entry-utility-prep-cat-links">
          <?php _e( 'Category: ', 'your-theme' ); ?>
          </span><?php echo get_the_category_list(', '); ?></span><br />
