...
<div id="Header">
	<div id="HeaderLinks">
    	<div class="headerBlock">
    		<div id="checkUsOut">
    			<a href="#" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/Facebook.png" alt="Facebook" /></a>
    			<a href="http://twitter.com/#!/MichaelMClarke" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/Twitter.png" alt="Twitter" /></a>
    		</div>
    	</div>
        <div class="headerBlock">
